...
function chuoi_doi_xung(str) {
    ...
    for (let i = arr.length - 1; i >= 0; i--) {
        arrInverse.push(arr[i])

    }
    let inverseString = arrInverse.join('')
...
function sortByName(arr) {
    let toLowerArr = arr.toLowerCase()

}
sortByName[{ name: "Huy", age: 16 }, { name: "huy", age: 16 }, { name: "zack", age: 16 }]
/*TONG HOP*/
//bai 1
//bai 2
function frog(x,y,h) {
    let doan_duong_di_1_ngay = x-y
    
    let tong_so_ngay = h / doan_duong_di_1_ngay
    console.log(tong_so_ngay)
